...
class BaseOrchestrator:
    ...
    def _write_ontology(
        ...
        with OntologyWriter(
            onto_path, creator="qpx", compression=self._compression
        ) as writer:
    ...
    def _write_provenance(
        ...
        with ProvenanceWriter(
            prov_path, creator="qpx", compression=self._compression
        ) as writer:
    ...
    def _write_dataset(
        ...
        *,
        ...
        with DatasetWriter(
            ds_path, creator="qpx", compression=self._compression
        ) as writer:
