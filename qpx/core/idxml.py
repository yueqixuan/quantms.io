"""
IdXML parser for qpx package.
This module provides functionality to parse OpenMS IdXML files and convert them to QPX PSM format.
"""
...
class IdXML:
    ...
    This class provides functionality to parse IdXML files and convert them to QPX PSM format.
