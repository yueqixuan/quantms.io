...
@click.option("--report-path", help="DIA-NN report file path", required=True, type=click.Path(exists=True, dir_okay=False, path_type=Path))
@click.option("--qvalue-threshold", help="Q-value threshold for filtering", required=True, default=0.05, type=float)
@click.option("--mzml-info-folder", help="mzML info file folder", required=True, type=click.Path(exists=True, file_okay=False, path_type=Path))
@click.option("--sdrf-path", help="SDRF file path for metadata", required=True, type=click.Path(exists=True, dir_okay=False, path_type=Path))
...
@click.option("--file-num", help="Number of files to process simultaneously", default=100, type=int)
